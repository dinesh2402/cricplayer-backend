...
public class FirstClass {
	...
	private String inns;
	private String mat;
	public FirstClass(String fifties, String centuries, String st, String ct, String sixs, String fours, String sr,
			String bf, String ave, String hs, String runs, String no, String inns, String mat) {
		super();
	...
	public String toString() {
		return "FirstClass [fifties=" + fifties + ", centuries=" + centuries + ", st=" + st + ", ct=" + ct + ", sixs="
				+ sixs + ", fours=" + fours + ", sr=" + sr + ", bf=" + bf + ", ave=" + ave + ", hs=" + hs + ", runs="
				+ runs + ", no=" + no + ", inns=" + inns + ", mat=" + mat + "]";
	}
