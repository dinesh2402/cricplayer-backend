...
public class ListA {
	...
	public ListA(String fifties, String centuries, String st, String ct, String sixs, String fours, String sr,
	...
	public String toString() {
		return "ListA [fifties=" + fifties + ", centuries=" + centuries + ", st=" + st + ", ct=" + ct + ", sixs=" + sixs
