...
public class Odis {
	...
	public Odis(String fifties, String centuries, String st, String ct, String sixs, String fours, String sr,
	...
	public String toString() {
		return "Odis [fifties=" + fifties + ", centuries=" + centuries + ", st=" + st + ", ct=" + ct + ", sixs=" + sixs
