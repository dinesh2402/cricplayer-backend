...
public class Odis {
	...
	public Odis(String tenper, String fiveper, String fourper, String sr, String econ, String ave, String bbm,
	...
	public String toString() {
		return "Odis [tenper=" + tenper + ", fiveper=" + fiveper + ", fourper=" + fourper + ", sr=" + sr + ", econ="
