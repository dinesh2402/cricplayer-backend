...
public class TestMs {
	...
	public TestMs(String tenper, String fiveper, String fourper, String sr, String econ, String ave, String bbm,
	...
	public String toString() {
		return "Tests [tenper=" + tenper + ", fiveper=" + fiveper + ", fourper=" + fourper + ", sr=" + sr + ", econ="
