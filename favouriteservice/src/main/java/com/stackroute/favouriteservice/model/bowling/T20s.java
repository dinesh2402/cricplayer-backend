...
public class T20s {
	...
	public T20s(String tenper, String fiveper, String fourper, String sr, String econ, String ave, String bbm,
	...
	public String toString() {
		return "T20s [tenper=" + tenper + ", fiveper=" + fiveper + ", fourper=" + fourper + ", sr=" + sr + ", econ="
