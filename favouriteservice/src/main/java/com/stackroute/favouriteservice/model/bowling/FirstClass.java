package com.stackroute.favouriteservice.model.bowling;
...
public class FirstClass {
	...
	public FirstClass(String tenper, String fiveper, String fourper, String sr, String econ, String ave, String bbm,
	...
	public String toString() {
		return "FirstClass [tenper=" + tenper + ", fiveper=" + fiveper + ", fourper=" + fourper + ", sr=" + sr
				+ ", econ=" + econ + ", ave=" + ave + ", bbm=" + bbm + ", bbi=" + bbi + ", wkts=" + wkts + ", runs="
				+ runs + ", balls=" + balls + ", inns=" + inns + ", mat=" + mat + "]";
	}
